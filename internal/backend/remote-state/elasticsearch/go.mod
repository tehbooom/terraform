module github.com/hashicorp/terraform/internal/backend/remote-state/elasticsearch
...
replace github.com/hashicorp/terraform/internal/backend/remote-state/elasticsearch => ../elasticsearch
